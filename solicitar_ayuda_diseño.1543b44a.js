...
var CONTRACT_NAME = "dev-1633064840124-33851795894369" || 'waat.testnet';
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/home/waat", "/.near/validator_key.json"),
...
},{"near-api-js":"../node_modules/near-api-js/lib/browser-index.js","./config":"config.js"}],"solicitar_ayuda_diseño.js":[function(require,module,exports) {
"use strict";
...
var _getConfig = (0, _config.default)("development" || 'development'),
    networkId = _getConfig.networkId; // Variable global para almacenar usuario near de el proyecto


var usuarioNearFondeo; // const submitButton = documento.querySelector('form button')
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            alert('Algo salió mal :( ' + '¿Quizás necesites salir y volver a entrar?' + 'Verifica la consola de tu navegador para mas información.');
            throw _context.t0;
...
document.querySelector('#sign-out-button').onclick = _utils.logout; // Mostrar el contenedor con el flujo para la sesión iniciada
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            usuarioNearFondeo = _context2.sent;
            document.querySelectorAll('[data-behavior=greeting]').forEach(function (el) {
              // set divs, spans, etc
              el.innerText = usuarioNearFondeo; // set input elements
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","solicitar_ayuda_diseño.js"], null)
//# sourceMappingURL=/solicitar_ayuda_diseño.1543b44a.js.map